  ...
  <!-- Item 1 -->
	...
	<li>
		<div class="direction-r">
			...
			<div class="desc"> Used Tableau to create dashboards and visualise data in a meaningful way. <br> Used Python to implement fuzzy logic to unstructured text data to find repetitions</div>
		</div>
	</li>
